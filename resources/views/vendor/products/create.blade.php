              ...
              <div class="mb-6 col-12">
                ...
                <div class="mt-1">
                  <textarea id="description"
                    ...
                    rows="15"
                    class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:border-indigo-400 dark:focus:ring-indigo-400">{{ old('description') }}</textarea>
                </div>
